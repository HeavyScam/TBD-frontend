...
function Home() {
    ...
    if (loading) {
        ...
        <div className="loader bounce2">
            ...
            <h1 style={{color:'white',fontSize:'28px', paddingTop:'230px', fontWeight:'700'}}>The Best Date</h1>
    ...
    return (
        <>
            <header className="sticky fade-in-down top-0 z-50 grid grid-cols-3 drop-shadow-md p-5 md:px-10" style={{ display: "flex", marginTop:'1%' }}>
                <a href='/'>
                <div>
                    <img src={Logo} alt="Loading..." className='load' style={{height:'60px',width:'60px', marginRight:'300px', marginTop:'-1%'}} />
                    <span className="text-white" style={{ fontSize:"20px", marginLeft:'64px', fontWeight:'600' }}>The Best Date</span>
            ...
            <div className="grid grid-cols-3 drop-shadow-md p-5 md:px-10 fade-in-left" style={{ display: "flex", marginTop:"15%" }}>
                <div>
                    ...
                    <button className=" text-white btn1 flex-end font-bold py-2 px-10" style={{fontSize: "16px", marginTop:"1%"}} onClick={redirect}>DOWNLOAD</button>
